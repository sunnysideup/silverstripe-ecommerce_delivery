if (
  null !==
    document.getElementById(
      'PickUpOrDeliveryModifier_Form_PickUpOrDeliveryModifier'
    ) &&
  'undefined' !==
  ...
  var PickUpOrDeliveryModifier = {
    ...
    init: function () {
      if ('undefined' === typeof a) {
        var a = require('./EcomCart')
        this.EcomCart = a.EcomCart
      } else PickUpOrDeliveryModifier.EcomCart = a
      'undefined' !== typeof PickUpOrDeliveryModifierOptions &&
      ...
      jQuery(
        ...
        : (jQuery('#' + PickUpOrDeliveryModifier.formID).show(),
          (a = {
            beforeSubmit: PickUpOrDeliveryModifier.showRequest,
            success: PickUpOrDeliveryModifier.showResponse,
            dataType: 'json'
          }),
          jQuery('#' + PickUpOrDeliveryModifier.formID).ajaxForm(a),
          jQuery(
            '#' +
              PickUpOrDeliveryModifier.formID +
              ' .' +
    ...
    showRequest: function (a, b, c) {
      jQuery('#' + PickUpOrDeliveryModifier.formID).addClass(
        PickUpOrDeliveryModifier.loadingClass
      )
      return !0
    },
    showResponse: function (a, b) {
      jQuery('#' + PickUpOrDeliveryModifier.formID).removeClass(
        PickUpOrDeliveryModifier.loadingClass
      )
      PickUpOrDeliveryModifier.EcomCart.setChanges(a)
    },
    addAvailableCountriesItem: function (a, b) {
      PickUpOrDeliveryModifier.availableCountries[a] = b
      return this
    },
    addItem: function (a, b) {
      this.addAvailableCountriesItem(a, b)
      return this
    },
    updateCountryList: function () {
      var a = jQuery(
        ...
        b = jQuery(PickUpOrDeliveryModifier.countryDropdownSelector).val(),
        a = PickUpOrDeliveryModifier.availableCountries[a],
        c = !1
      if (void 0 == a || 'undefined' == typeof a) a = []
      1 > a.length
        ? jQuery(
      ...
      for (var d = 0; d < a.length; d++)
        jQuery(
          ...
          b == a[d] && (c = !0)
      1 == a.length &&
        (jQuery(PickUpOrDeliveryModifier.countryDropdownSelector).val(a[0]),
        (c = !0))
      c
        ? jQuery(
            PickUpOrDeliveryModifier.countryDropdownSelector +
